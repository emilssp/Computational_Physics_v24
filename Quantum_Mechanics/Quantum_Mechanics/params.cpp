...
const unsigned long int SPACESTEPS = 10000; // number of space discretization steps
const unsigned long int TIMESTEPS  = 10000;// number of time discretization steps 
